function varargout = GuiCode_guide(varargin)
...
% set handle sizes
set(handles.figure1,'position',[18,14,70,40])
...
function varargout = GuiCode_OutputFcn(hObject, ch_selected, handles) 
...
function [ch_selected,sc_selected] = pushbutton1_Callback(hObject, eventdata, handles)
