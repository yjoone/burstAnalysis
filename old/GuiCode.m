...
% Last Modified by GUIDE v2.5 18-Feb-2017 00:57:25
...
set(handles.pushbutton1,'string','Plot','fontsize',30)
...
function GuiCode_OutputFcn(hObject, eventdata, handles) 
...
set(gca,'xlim',[0 ceil(max_ts/binsize_s)]);
set(gca,'ylim',[0 1e3]);
ylabel('Spike Rate')
