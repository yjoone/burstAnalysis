...
% Last Modified by GUIDE v2.5 14-Apr-2017 02:19:41
...
xlimrange = [datatipInfo.Position(1,1)-1 datatipInfo.Position(1,1)];
...
% get channel info
ch_i_selected = get(handles.listbox1,'Value');
maxCh = handles.output.UserData.maxCh;
ch_b = ones(1,maxCh);
...
if ch_i_selected ~= 1 
    ...
    set(handles.output.UserData.rasterAh,'ylim',ch_range)
end
