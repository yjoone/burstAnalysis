function [dataStruct_c] =combineRecordingData(dataStruct_1,dataStruct_2)
...
dataStruct_c.snips.eNe1.ts = [ts_1; (max(ts_1)+ts_2)];
dataStruct_c.snips.eNe1.chan = [chan_1; chan_2];
dataStruct_c.snips.eNe1.sortcode = [sortcode_1; sortcode_2];
